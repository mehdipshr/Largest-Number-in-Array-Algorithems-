var arr = [1, 3, 4, 45, 5446, 546, 6754, 23];
...
function largestOfFour(arr) {
    ...
    for (var arrayIndex = 0; arrayIndex < arr.length; arrayIndex++) {
        ...
        for (
            var subArrayIndex = 0; subArrayIndex < arr[arrayIndex].length; subArrayIndex++
        ) {
